...
static u8* str_A      = (u8*)"   A  ";
static u8*	str_B		   = (u8*)"   B  ";
static u8* str_SELECT = (u8*)"SELECT";
static u8*	str_START	 = (u8*)"START ";
static u8*	str_RIGHT	 = (u8*)"RIGHT ";
static u8*	str_LEFT	 = (u8*)" LEFT ";
static u8* str_UP		 = (u8*)"  UP  ";
static u8*	str_DOWN	 = (u8*)" DOWN ";
static u8* str_R		   = (u8*)"   R  ";
static u8* str_L		   = (u8*)"   L  ";
